...
from mxutils.DataFrame import DataFrame
...
if __name__ == '__main__':
    ...
    hgncStatusIdx = hgncData.getColumnIndex("Status")
    ...
    for result in hgncData:
        ...
        entryStatus = result[hgncStatusIdx]
        
        if entryStatus in ["Entry Withdrawn", "Symbol Withdrawn"]:
            continue

...
EN_CORE_SCI_LG="$MAINDIR/spacy_models/en_core_sci_lg-0.2.4/en_core_sci_lg/en_core_sci_lg-0.2.4"
EN_NER_BIONLP13="$MAINDIR/spacy_models/en_ner_bionlp13cg_md-0.2.4/en_ner_bionlp13cg_md/en_ner_bionlp13cg_md-0.2.4"
...
# nohup bash aggregate_pubmed.sh > nohup_pubmed_aggregate &
